...
Source: [`src/fuzz/fuzz_target_mnemonics.cpp`](../../src/fuzz/fuzz_target_mnemonics.cpp)

Entry points exercised:

- `Crypto::Mnemonics::encode (every supported language)`
- `Crypto::Mnemonics::decode and decode_raw`
- `Round-trip across NFC and NFD user input`
