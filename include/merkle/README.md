...
Source: [`src/fuzz/fuzz_target_merkle.cpp`](../../src/fuzz/fuzz_target_merkle.cpp)

Entry points exercised:

- `Crypto::Merkle::root_hash`
- `Crypto::Merkle::tree_branch`
- `Crypto::Merkle::root_hash_from_branch`
- `merkle_branch_t deserialization (binary + JSON)`
