...
Source: [`src/fuzz/fuzz_target_slip39.cpp`](../../src/fuzz/fuzz_target_slip39.cpp)

Entry points exercised:

- `Crypto::SLIP39::split (T-of-N share generation)`
- `Crypto::SLIP39::combine (share recombination)`
- `Crypto::SLIP39::derive_seed`
- `Iteration-exponent and passphrase-protected paths`
