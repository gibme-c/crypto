...
Source: [`src/fuzz/fuzz_target_ringct.cpp`](../../src/fuzz/fuzz_target_ringct.cpp)

Entry points exercised:

- `Crypto::RingCT::generate_pedersen_commitment`
- `Crypto::RingCT::generate_pseudo_commitments`
- `Crypto::RingCT::check_commitments_parity`
- `Crypto::RingCT::generate_amount_mask / toggle_masked_amount`
